  ...
  return (
    <>
      <CustomModal
        ...
        description={`Complete details for booking ID ${bookingId}`}
        size="xl"
      >
        {/* Content */}
        ...
        {/* 🔹 Footer Buttons (4 buttons) */}
        <div className="sticky bottom-0 bg-white border-t px-6 py-3 flex flex-wrap gap-3 justify-between mt-6">
          {/* Cancel Booking */}
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <Button
