...
export default function TrustSection() {
  const trustPoints = [
    ...
    },
    {
      ...
      title: "Clean Code",
      description:
        "We deliver maintainable, well-documented code that follows industry best practices.",
    },
    {
      icon: Clock,
      title: "On-Time Delivery",
      description:
        "We respect your timelines and deliver projects on schedule without compromising quality.",
    },
    {
      icon: Users,
    ...
    <section className="py-24 bg-[#F8FAFC] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20 border-b border-gray-100 pb-12">
          ...
          >
            Engineering excellence combined with a deep commitment to your
            long-term growth.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {trustPoints.map((point, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="relative h-full p-8 bg-white/80 backdrop-blur-sm border border-gray-100 rounded-[2.5rem] shadow-sm transition-all duration-500 group-hover:shadow-2xl group-hover:shadow-[#10B5DB]/10 group-hover:border-[#10B5DB]/20 flex flex-col items-center text-center">
