    ...
    const fetchAddresses = async () => {
      ...
      const [inAddr, outAddr] = await Promise.all([
        checkInLat && checkInLng
          ? getAddressFromCoordinates(checkInLat, checkInLng)
          : null,
        checkOutLat && checkOutLng
          ? getAddressFromCoordinates(checkOutLat, checkOutLng)
          : null,
      ]);
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {attendance?.shift?.name || "No shift assigned"}
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          {(attendance?.checkInLocation?.lat ||
            attendance?.checkOutLocation?.lat) && (
            <Card className="border-l-4 border-l-purple-500">
              ...
              <CardContent className="space-y-4">
                {/* Check In Location */}
                {attendance?.checkInLocation?.lat &&
                  attendance?.checkInLocation?.lng && (
                        ...
                        <div className="flex-1">
                          ...
                          {loadingAddresses ? (
                            ...
                            <p className="text-sm text-green-800 mt-1">
                              {checkInAddress ||
                                `Lat: ${attendance.checkInLocation.lat}, Lng: ${attendance.checkInLocation.lng}`}
                            </p>
                          )}
                        </div>
                      </div>
                ...
                {/* Check Out Location */}
                {attendance?.checkOutLocation?.lat &&
                  attendance?.checkOutLocation?.lng && (
