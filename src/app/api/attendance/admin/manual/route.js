...
// //app/api/attendance/admin/manual/route.js
...
//     if (!shiftId || !date || !status) {
//       return NextResponse.json({ success: false, message: "Shift, date and status are required" }, { status: 400 });
//     }
