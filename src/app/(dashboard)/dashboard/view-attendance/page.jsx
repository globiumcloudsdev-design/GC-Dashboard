...
const handleEditAttendance = (attendance) => {
  ...
  setManualForm({
    ...
    checkOutTime: formatTimeOnly(attendance.checkOutTime),
    notes: attendance.notes || "",
    isInformed: attendance.isInformed || false // Add this line
  });
  setShowEditModal(true);
};
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
                        {/* Status Filter */}
                        <div className="space-y-1">
                          <Label htmlFor="leaveStatus" className="text-xs">Status</Label>
                          <Select
                            value={filters.status}
                            onValueChange={(value) => handleFilterChange('status', value)}
                          >
                            <SelectTrigger id="leaveStatus" className="w-full text-sm h-9">
                              <SelectValue placeholder="All Status" />
                            </SelectTrigger>
                            <SelectContent>
                              <SelectItem value="all">All Status</SelectItem>
                        ...
                        {/* Month Filter */}
                        <div className="space-y-1">
                          <Label htmlFor="leaveMonth" className="text-xs">Month</Label>
                          <Select
                            value={filters.month}
                            onValueChange={(value) => handleFilterChange('month', value)}
                          >
                            <SelectTrigger id="leaveMonth" className="w-full text-sm h-9">
                              <SelectValue placeholder="Select Month" />
                            </SelectTrigger>
                            <SelectContent>
                              {Array.from({ length: 12 }, (_, i) => {
                        ...
                        {!isSmallScreen && (
                          <>
                            <div className="space-y-1">
                              <Label htmlFor="leaveFromDate" className="text-xs">From Date</Label>
                              <Input
                                id="leaveFromDate"
                                type="date"
                                value={filters.fromDate || ''}
                            ...
                            <div className="space-y-1">
                              <Label htmlFor="leaveToDate" className="text-xs">To Date</Label>
                              <Input
                                id="leaveToDate"
                                type="date"
                                value={filters.toDate || ''}
                      ...
                      {showAdvancedFilters && (
                        <div className="border rounded-lg p-4 space-y-4 bg-gray-50/50 animate-in fade-in duration-300">
                          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            {/* Specific Date */}
                            <div className="space-y-2">
                              <Label htmlFor="leaveSpecificDate" className="text-xs font-medium">Specific Date</Label>
                              <Input
                                id="leaveSpecificDate"
                                type="date"
                                value={filters.date || ''}
                                onChange={(e) => handleFilterChange('date', e.target.value)}
                                className="text-sm"
                            ...
                            {/* Reset to Default */}
                            <div className="space-y-2 col-span-full flex gap-2 justify-end items-center pt-2 border-t">
                              <Button
                                variant="ghost"
                                size="sm"
                                onClick={() => {
